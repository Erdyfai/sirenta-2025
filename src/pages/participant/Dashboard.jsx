    ...
    <div className="">
      ...
      <div className="min-h-screen w-[90%] mx-auto pt-28">
        ...
        <div className="max-w-7xl mx-auto text-left pt-6 pb-6">
          ...
          <h2 className="text-4xl font-bold text-gray-800">Sistem Rekrutmen Asisten Laboratorium Informatika UMM</h2>
        </div>
        ...
        <div className="max-w-7xl mx-auto bg-white rounded-xl shadow-md p-6">
          ...
          <div className="mb-6 text-center">
            <h2 className="text-xl font-semibold text-gray-800">
              {isSelectionOngoing ? (isUserApplicant ? 'Progress Saya' : 'Pendaftaran Ditutup') : 'Seleksi Telah Selesai'}
            </h2>
            <h3 className="text-lg font-medium text-gray-700">
              {isSelectionOngoing ? 'Open Recruitment Asisten Lab 2025' : 'Terima kasih atas partisipasi Anda'}
            </h3>
          ...
          <div className="border-t border-gray-300 pt-6">
            {isSelectionOngoing ? isUserApplicant ? <Timeline /> : <RegistrationClosed /> : <SelectionComplete />}
          </div>
